...
namespace HandyCalendar.Code
{
    internal static class PersianCalendarHelper
    {
        ...
        public static string ToCurrentCultureString(DateTime dt, string format, DateTimeFormatInfo formatProvider)
        {
        ...
        {
            var dateTimeFormat = GetDateTimeFormatInfo();
            return ToCurrentCultureString(dt, format, dateTimeFormat);
        }
